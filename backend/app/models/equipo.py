...
class Equipo(Base):
    ...
    equipo_real_id     = Column(Integer, ForeignKey("equipos_reales.id"), nullable=True)
    # Moto2
    ...
    # Capitanes por categoría (máx 3 usos por temporada cada uno)
    capitan_motogp_id  = Column(Integer, ForeignKey("pilotos.id"), nullable=True)
    capitan_moto2_id   = Column(Integer, ForeignKey("pilotos.id"), nullable=True)
    capitan_moto3_id   = Column(Integer, ForeignKey("pilotos.id"), nullable=True)
    # Comodín
